...
<style type="text/css">
  ...
  @if($eco_com_applicant->economic_complement->economic_complement_modality->economic_complement_type->id > 1)
    <table class="table" style="width:100%;">
      ...
      <tr>
          <td>FECHA NACIMIENTO:</td><td> {!! $affiliate->getShortBirthDate() !!}</td><td>EDAD:</td><td>{!! $affiliate->getAge() !!}</td>
      </tr>
    </table>
  @endif
  {{--Información derechohabiente--}}
    <table class="table" style="width:100%;">
      ...
      @endif
      <tr>
          <td>FECHA NACIMIENTO:</td><td> {!! $eco_com_applicant->getShortBirthDate() !!}</td><td>EDAD:</td><td>{!! $eco_com_applicant->getAge() !!}</td>
      </tr>
      <tr>
        <td>TELÉFONO:</td>
        <td>
