...
<div id="project">
  ...
  <table>
    ...
    <tr>
      <td>2</td>
      <td style="text-align:justify;font-size:0.9em;">Mi causahabiente perteneció al sector pasivo de la Policía Boliviana y acredita en la Certificación de Años de Servicio emitido por el Comando General de la Policía Boliviana como mínimo de 16 años de servicio, asimismo, <strong>No</strong> fue dado de baja en forma obligatoria o voluntaria de la Policía Boliviana.</td>
    </tr>
    <tr>
      <td>3</td>
      <td style="text-align:justify;font-size:0.9em;">La información y documentación proporcionada por mi persona, tanto verbal como la contenida en documentos respecto a los requisitos mínimos para acceder al Beneficio del Complemento Económico, es totalmente <strong>real y fidedigna</strong>, por lo que me hago totalmente responsable de la misma.</td>
    </tr>
    <tr>
      <td>4</td>
  ...
  <table>
    <tr>
      ...
      <th class="info" style="border-bottom: 1px solid  #3c3c3c!IMPORTANT;text-align:center;width: 22%;"><p>&nbsp;</p><br><br><br></th>
    ...
    <tr>
      <th class="info" style="border: 0px;text-align:center;">
        ...
        {!! $eco_com_applicant->getTitleNameFull() !!} <br>C.I. {!! $eco_com_applicant->identity_card !!} {!! $eco_com_applicant->city_identity_card->shortened ?? '' !!}
        </span>
      </th>
