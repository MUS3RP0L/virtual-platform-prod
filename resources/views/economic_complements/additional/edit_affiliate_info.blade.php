        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                        {!! Form::text('last_name_affi', $affiliate->last_name, ['class'=> 'form-control', 'onkeyup' => 'this.value=this.value.toUpperCase()']) !!}
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <div class="input-group">
                            <input type="text" id="birth_date_affi_mask" class="form-control" name="birth_date_affi" value="{!! $affiliate->getEditBirthDate() !!}" data-inputmask="'alias': 'dd/mm/yyyy'" data-mask>
