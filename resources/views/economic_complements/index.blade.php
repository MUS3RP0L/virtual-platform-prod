...
@section('contentheader_title')
    <div class="row">
        ...
        <div class="col-md-6 text-right">
            ...
            <div class="btn-group" style="margin:-3px 0;" data-toggle="tooltip" data-placement="top" data-original-title="Exportar Senasir">                
                <a href="" class="btn btn-info btn-raised" data-target="#myModal-senasir" data-toggle="modal"><i class="fa fa-file"></i></a>
            </div>
            <div class="btn-group" style="margin:-3px 0;" data-toggle="tooltip" data-placement="top" data-original-title="Validación Automática">                
            ...
            <div class="btn-group" style="margin:-3px 0;" data-toggle="tooltip" data-placement="top" data-original-title="Planilla General">                
                ...
                <ul class="dropdown-menu">
                    ...
                    <li><a href="" data-toggle="modal" data-target="#myModal-wf_sup_prestamos" data-toggle="modal">&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa  fa-caret-right"></i>Supendidos por prestamo</a></li>
                    <li><a href="" data-toggle="modal" data-target="#myModal-wf_sup_fondo" data-toggle="modal">&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa  fa-caret-right"></i>Supendidos por Rep. de Fondos</a></li>
            ...
            <div class="btn-group" style="margin:-3px 0;" data-toggle="tooltip" data-placement="top" data-original-title="Exportar Banco">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li role="separator" class="divider"></li>
                    <li><a href="" data-toggle="modal" data-target="#myModal-exportbanco-2" style="padding:3px 5px;"><i class="fa fa-money"></i>Banco 2</a></li>
                    <li role="separator" class="divider"></li>
                    <li><a href="" data-toggle="modal" data-target="#myModal-exportbanco-3" style="padding:3px 5px;"><i class="fa fa-money"></i>Banco 3</a></li>
                    <li role="separator" class="divider"></li>
...
@section('main-content')
    ...
    <div id="myModal-senasir" class="modal fade bs-example-modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="box-header with-border">
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                            <h4 class="modal-title">Exportar Derechohabientes de Senasir</h4>
                        </div>
                        <div class="modal-body">

                            {!! Form::open(['method' => 'POST', 'route' => ['export_senasir'], 'class' => 'form-horizontal', 'files' => true ]) !!}
    ...
    {{-- EXPORT FOR BANK 2 --}}
    <div id="myModal-exportbanco-2" class="modal fade bs-example-modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="box-header with-border">
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                            <h4 class="modal-title">Exportar Afiliados de Complemento Económico - BANCO 2 </h4>
                        </div>
                        <div class="modal-body">

                            {!! Form::open(['method' => 'POST', 'route' => ['export_bank_two'], 'class' => 'form-horizontal', 'files' => true ]) !!}
    ...
    </div>{{-- EXPORT FOR BANK 3 --}}
    <div id="myModal-exportbanco-3" class="modal fade bs-example-modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="box-header with-border">
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                            <h4 class="modal-title">Exportar Afiliados de Complemento Económico - BANCO 3 </h4>
                        </div>
                        <div class="modal-body">

                            {!! Form::open(['method' => 'POST', 'route' => ['export_bank_three'], 'class' => 'form-horizontal', 'files' => true ]) !!}
...
<div id="myModal-wf_sup_fondo" class="modal fade bs-example-modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel">
          <div class="modal-dialog">
              <div class="modal-content">
                  <div class="box-header with-border">
                      <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                      <h4 class="modal-title">Exportar Supendidos por Reposicion de Fondos</h4>
                  </div>
                  <div class="modal-body">

                      {!! Form::open(['method' => 'POST', 'route' => ['export_wf_sup_fondo'], 'class' => 'form-horizontal', 'files' => true ]) !!}
...
<div id="myModal-wf_sup_contabilidad" class="modal fade bs-example-modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel">
          <div class="modal-dialog">
              <div class="modal-content">
                  <div class="box-header with-border">
                      <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                      <h4 class="modal-title">Exportar Supendidos por Contabilidad</h4>
                  </div>
                  <div class="modal-body">

                      {!! Form::open(['method' => 'POST', 'route' => ['export_wf_sup_contabilidad'], 'class' => 'form-horizontal', 'files' => true ]) !!}
...
<div id="myModal-wf_sup_prestamos" class="modal fade bs-example-modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel">
          <div class="modal-dialog">
              <div class="modal-content">
                  <div class="box-header with-border">
                      <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                      <h4 class="modal-title">Exportar Supendidos por Prestamos</h4>
                  </div>
                  <div class="modal-body">

                      {!! Form::open(['method' => 'POST', 'route' => ['export_wf_sup_prestamos'], 'class' => 'form-horizontal', 'files' => true ]) !!}
...
<div id="myModal-wf_sup" class="modal fade bs-example-modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel">
          <div class="modal-dialog">
              <div class="modal-content">
                  <div class="box-header with-border">
                      <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
...
<div id="myModal-wfamort_prestamos" class="modal fade bs-example-modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel">
          <div class="modal-dialog">
              <div class="modal-content">
                  <div class="box-header with-border">
                      <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                      <h4 class="modal-title">Exportar Amortizados al 100% de Prestamos</h4>
                  </div>
                  <div class="modal-body">

                      {!! Form::open(['method' => 'POST', 'route' => ['export_wfamort_total_prestamos'], 'class' => 'form-horizontal', 'files' => true ]) !!}
...
<div id="myModal-wfamort_fondos" class="modal fade bs-example-modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel">
          <div class="modal-dialog">
              <div class="modal-content">
                  <div class="box-header with-border">
                      <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                      <h4 class="modal-title">Exportar Amortizados al 100% de Reposición de Fondos</h4>
                  </div>
                  <div class="modal-body">

                      {!! Form::open(['method' => 'POST', 'route' => ['export_wfamort_total_fondos'], 'class' => 'form-horizontal', 'files' => true ]) !!}
...
<div id="myModal-wfamort_contabilidad" class="modal fade bs-example-modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel">
          <div class="modal-dialog">
              <div class="modal-content">
                  <div class="box-header with-border">
                      <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                      <h4 class="modal-title">Exportar Amortizados al 100% de Contabilidad</h4>
                  </div>
                  <div class="modal-body">
...
<div id="myModal-Automatic_Validation" class="modal fade bs-example-modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel">
          <div class="modal-dialog">
              <div class="modal-content">
                  <div class="box-header with-border">
                      <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                      <h4 class="modal-title">Validación Automática</h4>
                  </div>
                  <div class="modal-body">

                      {!! Form::open(['method' => 'POST', 'route' => ['automatic_validation'], 'class' => 'form-horizontal', 'files' => true ]) !!}
                          ...
                          <div class="row">
                              <div class="col-md-12">
                                  <div class="form-group">
                                          {!! Form::label('checkt', 'Importar', ['class' => 'col-md-3 control-label']) !!}
                                      <div class="col-md-7">
                                          <div class="form-group">                                                
                                                {!! Form::checkbox('filexl', 'value', false, ['class' => 'checkbox from-control']) !!}
