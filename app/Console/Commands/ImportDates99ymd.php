...
class ImportDates99ymd extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'import:dates_99_c2';
                 ...
                 if ($this->confirm('Are you sure to import the folder "' . $FolderName . '" ? [y|N]') && $FolderName) {
                     ...
                     Excel::batch('public/file_to_import/' . $FolderName . '/', function($rows, $file) {
                         $rows->each(function($result) {
                                 ...
                                 $date_entry = null;
                                 if ($result->nac) {   
                                    $birth_date = Carbon::createFromFormat('Ymd','19'.$result->nac)->toDateString();
                                 }
                                 if ($result->ing) {   
                                    $date_entry = Carbon::createFromFormat('Ymd','19'.$result->ing)->toDateString();
                                 }
