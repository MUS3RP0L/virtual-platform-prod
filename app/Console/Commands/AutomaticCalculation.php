    ...
    {   
        ...
        if ($password == ACCESS) {
                ...
                {   $time_start = microtime(true);
		    		...
		    		$economic_complements=EconomicComplement::whereYear('year','=',$year)
		    								->where('semester','=',$semester)
		    								->get();
			    		$economic_complement_rent_temp = EconomicComplementRent::whereYear('year','=',$year)
			    					->where('semester','=',$semester)
		    						->get();
