...
class WorkflowRecord extends Model
{
    ...
    //         $wf_record->message="El usuario ".Util::getFullNameuser()." creó el trámite ".$economic_complement->code." ";
    //         $wf_record->save();
    //     }
    ...
    //             $wf_record->wf_state_id=$economic_complement->wf_current_state_id;
    //             $wf_record->record_type_id=1;
    //             $wf_record->message="El usuario ".Util::getFullNameuser()." ".Util::wfStateName($economic_complement->wf_current_state_id)." el trámite ".$economic_complement->code." .";
    //             $wf_record->save();
    //         }
    ...
    //             $wf_record->wf_state_id = $economic_complement->wf_current_state_id;
    //             $wf_record->record_type_id = 1;
    //             $wf_record->message = "El usuario " . Util::getFullNameuser() . " actualizó  el grado de " . ($old_economic_complement->degree->name ?? 'sin grado') . " a " . $economic_complement->degree->name . " del trámite ". $economic_complement->code . ".";
    //             $wf_record->save();
    //         }
    ...
    //             $wf_record->wf_state_id = $economic_complement->wf_current_state_id;
    //             $wf_record->record_type_id = 1;
    //             $wf_record->message = "El usuario " . Util::getFullNameuser() . " actualizó  la categoría de " . ($old_economic_complement->category->name ?? 'sin categoría') . " a " . $economic_complement->category->name . " del trámite ". $economic_complement->code . ".";
    //             $wf_record->save();
    //         }
