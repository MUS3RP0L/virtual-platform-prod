...
class AffiliateController extends Controller
{
    ...
    public function print_sworn_declaration1($affiliate)
    {
      $header1 = "DIRECCIÓN DE BENEFICIOS ECONÓMICOS";
      ...
      $data = $this->getData($affiliate);
      $affiliate = $data['affiliate'];
      $view = \View::make('affiliates.print.sworn_declaration1', compact('header1','header2','title','date','hour','affiliate'))->render();
      $pdf = \App::make('dompdf.wrapper');
    ...
    public function print_sworn_declaration2($affiliate)
    {
      $header1 = "DIRECCIÓN DE BENEFICIOS ECONÓMICOS";
      $header2 = "UNIDAD DE OTORGACIÓN DEL COMPLEMENTO ECONÓMICO";
      $title = "FORMULARIO DE DECLARACIÓN JURADA VOLUNTARIA";
      ...
      $affiliate = $data['affiliate'];
      $spouse = $data['spouse'];
      $view = \View::make('affiliates.print.sworn_declaration2', compact('header1','header2','title','date','hour','affiliate','spouse'))->render();
      $pdf = \App::make('dompdf.wrapper');
      $pdf->loadHTML($view)->setPaper('legal');
      return $pdf->stream();
    ...
    public function print_inclusion_solicitude($affiliate)
    {
      $header1 = "DIRECCIÓN DE BENEFICIOS ECONÓMICOS";
      $header2 = "UNIDAD DE OTORGACIÓN DEL COMPLEMENTO ECONÓMICO";
      $title = "";
      ...
      $view = \View::make('affiliates.print.inclusion_solicitude', compact('header1','header2','title','date','hour','affiliate'))->render();
      $pdf = \App::make('dompdf.wrapper');
      $pdf->loadHTML($view)->setPaper('letter');
      return $pdf->stream();
    }

    public function print_pay_solicitude($affiliate)
    {
      $header1 = "DIRECCIÓN DE BENEFICIOS ECONÓMICOS";
      $header2 = "UNIDAD DE OTORGACIÓN DEL COMPLEMENTO ECONÓMICO";
      $title = "";
      ...
      $affiliate = $data['affiliate'];
      //$documents = EconomicComplementSubmittedDocument::select(['id', 'eco_com_requirements','economic_complement_id', 'status'])->where('economic_complement_id', $economic_complement->id)->get();
      $view = \View::make('affiliates.print.pay_solicitude', compact('header1','header2','title','date','hour','affiliate'))->render();
      $pdf = \App::make('dompdf.wrapper');
      $pdf->loadHTML($view)->setPaper('letter');
      return $pdf->stream();
    }
