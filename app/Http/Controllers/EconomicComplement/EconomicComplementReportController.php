      ...
      case 1:
       ...
       break;
        ...
        case '22':
            ...
            ini_set('max_input_time', '-1');
            set_time_limit('-1');
            global $rows, $obs_mora, $obs_cont, $obs_repfo, $obs_juz, $legal_gua,$dom, $viudas, $concu;
            //planilla banco
            ...
            Excel::create('Planilla General Banco' . date("Y-m-d H:i:s"), function ($excel) {
                ...
                global $rows, $obs_mora, $obs_cont, $obs_repfo, $obs_juz, $legal_gua, $dom, $viudas;
