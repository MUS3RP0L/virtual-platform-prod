...
class EconomicComplementReportController extends Controller
{
   ...
   public function data_shet($id_complemento)
    ...
    public function print_total($eco_com_id)
    {
        ...
        $data = array_merge($data, $second_data);
        return \PDF::loadView('economic_complements.print.print_total', $data)->setOption('page-width', '215.9')->setOption('page-height', '330')->setOption('margin-bottom', 0)->setOption('margin-left', 0)/*->setOption('footer-left', 'PLATAFORMA VIRTUAL DE LA MUSERPOL - 2018')*/->stream('print_total.pdf');
