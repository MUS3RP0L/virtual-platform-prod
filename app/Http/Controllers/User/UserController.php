...
class UserController extends Controller
{
    ...
    {   
        ...
        if($admin)
        {
            Log::info("usuario es admin siguiendo logica anterior para no variar");
              if ($user) {
        ...
        // Log::info("role user :".json_encode(Auth::user()->roles()));
        // $rol = User::join('role_user','users.role_id','role_user.id')
        //            ->fe
        //            ->first();
