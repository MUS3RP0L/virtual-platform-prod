...
class SumarAportesCStoredProcedure extends Migration
{
    ...
    public function up() {
        ...
        DB::unprepared('CREATE OR REPLACE FUNCTION sum_contributionsC(month1 integer, year1 integer)
            ...
            FROM contributions WHERE MONTH(contributions.month_year) = month1 and YEAR(contributions.month_year) = year1 and contributions.breakdown_id <> 5;
            END;
            $$ LANGUAGE plpgsql;');
    ...
    public function down() {
        ...
        $sql = "DROP FUNCTION IF EXISTS sum_contributionsC(month1 integer, year1 integer)";
