...
class CreateStoredProdure extends Migration
{
    ...
    public function down()
    {
        ...
        $sql1 = "DROP FUNCTION IF EXISTS sum_contributionsB(month1 integer, year1 integer)";
